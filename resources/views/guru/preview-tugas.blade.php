    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mx-1">
            ...
            <div class="bg-white shadow-lg p-4 rounded-lg dark:bg-gray-900">
                ...
                <form action="{{ route('previewTugas.update', $tugas->id) }}" method="POST">
                    @csrf
                    @method('POST')
                    ...
                    <div class="mt-2 space-y-2">
                        ...
                        <input type="number" id="nilai" name="nilai" value="{{ $tugas->nilai }}" min="0"
                            max="100"
                ...
                <form action="{{ route('periksa.batal', $tugas->id) }}" method="POST" class="mt-4">
                    @csrf
                    @method('POST')
                    <button type="submit"
                        class="w-full bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-400 focus:outline-none">
                        Batal Periksa
                    </button>
                </form>
            </div>

    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            ...
            <div class="flex flex-col sm:flex-row items-center mx-4 sm:mx-10 mb-6">
                <div class="flex flex-wrap items-center space-x-4 mb-4 sm:mb-0 sm:space-x-4 flex-grow">
                    <button id="belumDiperiksaBtn"
                        class="bg-[#5E9EB2] text-white px-4 py-2 rounded-lg shadow-lg w-full sm:w-auto mb-2 sm:mb-0">Belum
                        Diperiksa</button>
                    <button id="sudahDiperiksaBtn"
                        class="bg-white text-[#5E9EB2] px-4 py-2 rounded-lg shadow-lg w-full sm:w-auto">Sudah
                        Diperiksa</button>
                </div>
                <select id="kelas"
                    class="bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 rounded-lg px-3 py-1.5 text-sm w-full sm:w-auto focus:outline-none focus:ring-2 focus:ring-[#5E9EB2]">
            ...
            <div id="sudahDiperiksaTable" class="overflow-x-auto relative shadow-md sm:rounded-lg mx-4 sm:mx-10 hidden">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            <td class="px-4 py-4 sm:px-6 sm:py-4">Joko Widodo</td>
                            <td class="px-4 py-4 sm:px-6 sm:py-4">XI DKV 2</td>
                            <td class="px-4 py-4 sm:px-6 sm:py-4">Fisika - Latihan Soal 3</td>

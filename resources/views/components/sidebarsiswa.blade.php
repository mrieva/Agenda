        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('tugas-siswa') }}"
                    class="flex items-center my-6 p-2 text-[#ffffff] rounded-lg dark:text-white hover:bg-[#fff] hover:bg-opacity-40 hover:z-0 hover:text-[#fff] dark:hover:bg-gray-700 group relative
                    {{ request()->routeIs('tugas-siswa') || request()->routeIs('siswa-tugas') ? 'bg-gray-100 bg-opacity-40 text-[#fff] dark:bg-gray-700' : '' }}">
                    <svg class="absolute w-5 h-5 text-gray-500 transition duration-75 dark:text-[#ffffff] group-hover:text-gray-900 dark:group-hover:text-white"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
            ...
            <li>
                <button type="button"
                    class="flex items-center w-full my-6 p-2 text-base text-[#ffffff] transition duration-75 rounded-lg group hover:bg-gray-100 hover:bg-opacity-40 dark:text-white dark:hover:bg-gray-700 {{ request()->is('notif-siswa') || request()->is('settings-siswa') ? 'bg-gray-100 bg-opacity-40 text-[#fff] dark:bg-gray-700' : '' }}
                    aria-controls="dropdown-example"
                    data-collapse-toggle="dropdown-example">
                    <a href="{{ route('settings-siswa') }}" class="flex items-center w-full">

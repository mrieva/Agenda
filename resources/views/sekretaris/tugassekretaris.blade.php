    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            ...
            <div class="flex items-center justify-start space-x-4 mb-6">
                <button class="px-4 py-2 text-sm font-semibold text-white bg-[#5E9EB2] rounded-lg">Belum Diserahkan</button>
                <button class="px-4 py-2 text-sm font-semibold text-[#5E9EB2] bg-white border border-[#5E9EB2] rounded-lg">Sudah Diserahkan</button>
                <button class="px-4 py-2 text-sm font-semibold text-[#5E9EB2] bg-white border border-[#5E9EB2] rounded-lg">Seleksi</button>
            </div>

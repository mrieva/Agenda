...
<body class="bg-gray-50 dark:bg-gray-900">
    ...
    <!-- Sidebar -->
    <x-sidebarsekret class="z-10"></x-sidebarsekret>
    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="max-w-7xl mx-auto p-4">
            ...
            <div id="linkModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden z-50">
            ...
            <div id="fileModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden z-50">

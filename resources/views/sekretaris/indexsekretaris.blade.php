    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-4 mx-10">
                <!-- XII RPL1 Card -->
                <div data-type="siswa" onclick="openModal('siswa')"
                ...
                <!-- Guru Card -->
                <div data-type="guru" onclick="openModal('guru')"
            ...
            <div class="p-4 mx-6">
                <div class="grid grid-cols-1 md:grid-cols-1 gap-16 mb-4 mx-10">
                    ...
                    <div class="w-full">
                        ...
                        <div
                            class="flex items-center h-24 rounded-xl bg-gradient-to-r from-[#6CC6EC] to-[#5E9EB2] w-full">
                        ...
                        <div id="communicationForm"
                            class="hidden mt-4 p-4 border-2 border-gray-200 rounded-lg bg-[#e6f5fc] dark:bg-gray-800 w-full">
                            <textarea
                            ...
                            <div class="flex justify-between items-center mt-4">
                                ...
                                <button class="bg-[#5E9EB2] text-white px-4 py-2 rounded hover:bg-blue-600">
                                    Posting
                                </button>
                            </div>
                        </div>
                ...
                <div
                    class=" p-4 rounded-lg mb-4 flex items-center h-20 bg-gradient-to-r from-[#6CC6EC] from-[-40%] to-[#5E9EB2] to70%">
            ...
            <form>
                <div class="mb-4">
                    ...
                    <input type="text" id="name" name="name"
                        class="w-full px-4 py-2 mt-2 bg-white border border-[#83a4ad] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5E9EB2] text-[#000]" />
                </div>
                <div class="mb-4">
                    <label for="kehadiran" class="block text-sm font-semibold">Kehadiran</label>
                    <select id="kehadiran" name="kehadiran"
                        class="w-full px-4 py-2 mt-2 bg-white border border-[#83a4ad] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5E9EB2]">
                ...
                <div class="mb-4">
                    ...
                    <input type="file" id="lampiran" name="lampiran"
                        class="rounded-xl w-full px-4 py-2 mt-2 bg-white border border-[#83a4ad] focus:outline-none focus:ring-2 focus:ring-[#5E9EB2] text[#000]" />
                </div>

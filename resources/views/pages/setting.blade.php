                ...
                <div class="grid grid-cols-2 gap-y-4 gap-x-2">
                    ...
                    <div class="col-span-2 grid grid-cols-3 gap-4">
                        <div class="mb-7">
                            ...
                            <input type="text" id="full-name" name="full-name"
                                class="mt-1 block w-80 px-3 py-2 border border-[#5E9EB2] rounded-md shadow-sm focus:outline-none focus:ring-[#5E9EB2] focus:border-[#5E9EB2]" />
                        </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <select id="kelas" name="kelas"
                            class="mt-1 block w-64 px-3 py-2 border border-[#5E9EB2] rounded-md shadow-sm focus:outline-none focus:ring-[#5E9EB2] focus:border-[#5E9EB2]">
                            <!-- Options -->

            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mx-6">
                ...
                <div class="col-span-1">
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-lg dark:bg-gray-900">
                        ...
                        <form action="{{ route('cancelSub', ['id' => $task->id]) }}" method="POST" class="mt-4" onsubmit="return confirm('Apakah Anda yakin ingin membatalkan penyerahan tugas? Pembatalan tugas akan mereset status diperiksa dan nilai Anda')">
                            @csrf
